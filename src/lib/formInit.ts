/**
 * form 展示层 init / css 配置（与 html_url 对称）
 */
...
export interface FormClientInitConfig extends ComponentsInitScriptDisplay, ComponentsCssDisplay {
  cssUrl: string;
}

export function resolveFormClientInit(
  metadata: Record<string, unknown> | undefined,
  locale: string
): FormClientInitConfig {
